...
const scheduleItems = [
  ...
  },
  {
    ...
    description: "Opening Speak and Remarks",
    icon: Heart,
  },
  {
    time: "3:00 PM",
    title: "Couple Entrance",
    description: "The couple makes Entry",
    icon: UtensilsCrossed,
  },
  {
    time: "3:30 PM",
    title: "Games",
    description: "Games, Drinks and Fun",
    icon: Music,
  },
  {
    time: "4:30 PM",
    title: "Couple's Dance",
    description: "Dance and Toast Celebration",
    icon: Heart,
  },
  {
    time: "5:00 PM",
    title: "Farewell",
    description: "Closing Remarks and Photographs",
    icon: Camera,
  },
]
